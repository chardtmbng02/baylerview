...
import { TestimonialsList } from "../admin-components/Testimonials/TestimonialsList";
        ...
        <div className="flex flex-col flex-1 overflow-y-auto">
          ...
          <div>
            <h1 className="text-gray-500 mx-5 pt-10 text-xl font-semibold">
              ...
              <span className="text-red-600">Received Testimonials</span>
            </h1>
            <h3 className="text-gray-500 mx-5 text-sm pb-10">
              You can manage testimonials record here.
            </h3>
          </div>
