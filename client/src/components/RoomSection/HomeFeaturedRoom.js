...
export const HomeFeaturedRoom = () => {
  ...
  //make a get request from https://baylerview-api.onrender.com/api/rooms mas okay if axios para malinis tingnan.
  //dapat kapag nag clg ka ng rooms ang lalabas yung array kagaya ng nasa ilalim na const rooms.
  //kapag nakapag fetch ka na ng rooms, ilimit mo lang yung rooms.map sa 3 items lang tapos alisin mo na yung hardcoded data.
        ...
        <div className="mb-4">
          <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-md leading-7 text-gray-500 font-light">
              Indulge in luxury, unwind in comfort - Your perfect sanctuary
              awaits.
            </p>
          </div>
        </div>
