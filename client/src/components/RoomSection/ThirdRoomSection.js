import Room1 from '../../assets/room-images/room-2.png';
import { useEffect, useState } from 'react';
import axios from 'axios';

export const ThirdRoomSection = () => {
        ...
        <div className="mb-4">
          <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
            <h2 className="font-heading mb-4 font-bold tracking-tight text-gray-900 text-3xl sm:text-5xl">
              Suite Bay-Ler's Rooms
            </h2>
            <p className="mx-auto mt-4 max-w-3xl text-md leading-7 text-gray-500 font-light">
              Indulge in Luxury: Unwind and Relax in Our Exquisite Suite Room
            </p>
          </div>
        </div>
